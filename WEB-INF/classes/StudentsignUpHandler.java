...
public class StudentsignUpHandler extends HttpServlet {
...
public void doPost(HttpServletRequest request, HttpServletResponse response)throws ServletException, IOException 
    ...
    out.println("<html>");
    out.println("<head>");
    out.println("<title>Servlet StudentsignUpHandler Servlet</title>");
    out.println("</head>");
    out.println("<body>");
    ...
    Statement st=con.createStatement();
     ...
     String query="insert into profile(email,name,dob,semester,phone_no,user_type) values('"+em+"', '"+nm+"', '"+d+"', '"+s+"', '"+p+"', '"+ut+"')"; 
